...
import com.example.babysafetyhouse.utils.MyDistanceUtils;
...
public class SearchMapActivity extends BaseActivity {
    ...
    private void initStatuseBar(){
        SystemBarTintManager mTintManager=new SystemBarTintManager(SearchMapActivity.this);
    ...
    private void init() {
        ...
        bdMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                Double distance=MyDistanceUtils.getDistanceFromXtoY(latitude,longitude,ll.latitude,ll.longitude);
                InfoWindow mInfoWindow = new InfoWindow(view,ll,-50);
                bdMap.showInfoWindow(mInfoWindow);
                TextView textView=(TextView)view.findViewById(R.id.text_marker_distance);
                TextView textView1=(TextView)view.findViewById(R.id.text_marker_title);
                final TextView textView2=(TextView)view.findViewById(R.id.text_marker_content);
                textView.setText("距离当前位置"+String.format("%.2f",distance)+"km");
                textView1.setText("众圆安全屋");
                ...
                geoCoder.setOnGetGeoCodeResultListener(new OnGetGeoCoderResultListener() {
                    ...
                    public void onGetReverseGeoCodeResult(ReverseGeoCodeResult reverseGeoCodeResult) {
                        ...
                        textView2.setText("众圆安全屋位于"+reverseGeoCodeResult.getAddress()+"，以其优雅安静的环境，优质诚恳的服务态度，秉承顾客至上的原则，只为给您的宝宝带来舒适的体验！");
                    }
                });
    ...
    public void btn_getinfo(View v){
        ...
        intent.putExtra("locationinfo",adress);
